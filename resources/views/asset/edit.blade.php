...
<body id="page-top">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="manufacture" name="manufacture" value="{{ $asset->manufacture }}" required>
    </div>

    <div class="form-group">
        <label for="jenis">Jenis</label>
        <input type="text" class="form-control" id="jenis" name="jenis" value="{{ $asset->jenis }}" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="tahun" name="tahun" value="{{ $asset->tahun }}" required>
    </div>
